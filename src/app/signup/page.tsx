          ...
          <div className="max-w-md mx-auto lg:mx-0">
            <div className="text-center lg:text-left mb-8">
              ...
              <p className="text-gray-600">
                Join Freedom Wall and start sharing your thoughts with the world
              </p>
            </div>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 lg:p-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Share Your Voice</h3>
                  <p className="text-gray-600 text-sm">Express yourself freely in a supportive community</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Connect with Others</h3>
                  <p className="text-gray-600 text-sm">Build meaningful relationships with like-minded people</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Real-time Engagement</h3>
                  <p className="text-gray-600 text-sm">Stay connected with instant notifications and live feeds</p>
                </div>
              </div>
